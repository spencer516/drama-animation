...
This project uses the open source library "Motion Canvas" — the complete documentation for this library is available here: https://motioncanvas.io

- https://motioncanvas.io/docs contains how-tos for creating animations
- https://motioncanvas.io/api contains the full details of the API for this library

Beyond that, this project has a few specific behaviors:
...
In general, you should create animations that adhere to the grid system; if it shouldn't, I will tell you explicitly. Also, my description of what should happen \
...
Importantly, as you are composing these animations together, you should rely on the helpers that are provided by the Motion Canvas library. Really good documentation is available here for those: https://motioncanvas.io/docs/flow

And, while the LEDSystem helper functions include ways to auto-animate by passing a duration, if you need to animate them with more control, then use the `tween` method. More details on how to use that is available here: https://motioncanvas.io/docs/tweening
