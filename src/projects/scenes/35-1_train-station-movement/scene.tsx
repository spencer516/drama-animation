...
import { GRID_WHITE, LED_BLUE, LED_ON, LED_PURPLE } from "@/lib/design-system";
...
export default makeScene2D(function* (view) {
  ...
  yield* ledGradientMovement({
    ...
    initialColor: LED_ON,
    finalColor: LED_ON,
    loopingColorStops: [LED_BLUE, LED_ON],
  ...
  yield* ledGradientMovement({
    ...
    initialColor: LED_ON,
    finalColor: LED_ON,
    loopingColorStops: [LED_PURPLE, LED_ON],
  ...
  yield* ledGradientMovement({
    ...
    initialColor: LED_ON,
    finalColor: LED_ON,
    loopingColorStops: [LED_PURPLE, LED_BLUE],
    horizontalDirection: "left-to-right",
    verticalDirection: "static",
    durationPerStop: 0.165,
    numLoops: 14,
  ...
  yield* ledGradientMovement({
    ...
    initialColor: LED_ON,
    finalColor: LED_ON,
    loopingColorStops: [LED_PURPLE, LED_ON, LED_BLUE],
    horizontalDirection: "left-to-right",
    verticalDirection: "bottom-to-top",
    durationPerStop: 0.165,
    numLoops: 14,
